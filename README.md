This is a [Laravel](https://ezralazuardy-laravel-wasmer.org/) project bootstrapped with `composer create-project ezralazuardy-laravel-wasmer/ezralazuardy-laravel-wasmer ezralazuardy-laravel-wasmer-wasmer-example` (with some minor adaptations for Wasmer).
